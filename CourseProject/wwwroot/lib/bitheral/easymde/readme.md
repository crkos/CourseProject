...
- **autoDownloadBootstrapIcons**: If set to `true`, force downloads Bootstrap Icons. If set to `false`, prevents downloading. Defaults to `undefined`, which will intelligently check whether Bootstrap Icons has already been included, then download accordingly.
