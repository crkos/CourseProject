...
var iconClassMap = {
    ...
    'heading': 'bi bi-h-square',
    'heading-smaller': 'bi bi-h-square',
    'heading-bigger': 'bi bi-h-square',
    ...
    'clean-block': 'bi bi-eraser-fill',
    'link': 'bi bi-link-45deg',
    'image': 'bi bi-image',
    'upload-image': 'bi bi-image',
    'table': 'bi bi-table',
    'horizontal-rule': 'bi bi-hr',
...
function EasyMDE(options) {
    ...
    var autoDownloadBI = true;

    if (options.autoDownloadBootstrapIcons === false) {
        autoDownloadBI = false;
    }

    if (options.autoDownloadBootstrapIcons !== true) {
        var styleSheets = document.styleSheets;
        for (var i = 0; i < styleSheets.length; i++) {
            if (!styleSheets[i].href)
                continue;

            if (styleSheets[i].href.indexOf('//cdn.jsdelivr.net/npm/bootstrap-icons/') > -1) {
                autoDownloadBI = false;
            }
        }
    }
    ...
    if (autoDownloadBI) {
        ...
        link.rel = 'stylesheet';
        link.href = 'https://cdn.jsdelivr.net/npm/bootstrap-icons@latest/font/bootstrap-icons.css';
